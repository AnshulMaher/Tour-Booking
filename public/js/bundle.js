...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiYW5zaHVsbWFoZXIiLCJhIjoiY2s0b3ZxY3c0MWk1ZzNkbDVha3U4Yjk3aSJ9.ELFTTEat2nb3uc1I_7aOew';
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', "".concat(type.toUpperCase(), " updated successfully! Reload to see changes"));
            }
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            stripe = Stripe('pk_test_Aia4Xrr2DfsW6ZU7kWHLDDq700tr6IVAIu'); // 1) Get checkout session from API
...
function () {
  ...
  regeneratorRuntime.mark(function _callee(e) {
    var btn, currentPassword, newPassword, newPasswordConfirm;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
...
},{}]},{},["C:/Users/anshul/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","index.js"], null)
